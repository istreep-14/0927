...
function valueMapForGame(game, fields){
  ...
  const map={
    ...
    'white.rating':white.rating!=null?String(white.rating):'', 'white.result':white.result||'', 'white.@id':white['@id']||'', 'white.id':white['@id']||'', 'white.username':white.username||'', 'white.uuid':white.uuid||'',
    'black.rating':black.rating!=null?String(black.rating):'', 'black.result':black.result||'', 'black.@id':black['@id']||'', 'black.id':black['@id']||'', 'black.username':black.username||'', 'black.uuid':black.uuid||'',
